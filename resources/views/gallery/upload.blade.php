...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
        ...
        <!-- Card utama -->
        <form action="{{ route('gallery.upload.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100">
                    <div class="rounded-lg border border-dashed border-gray-200 bg-gray-50 p-4 flex items-center justify-between gap-4">
                        <div class="flex items-center gap-4">
                            <div id="selected-frame-preview" class="w-28 h-20 bg-white rounded-lg border border-gray-200 flex items-center justify-center text-gray-400 overflow-hidden">
                                <!-- Placeholder gambar frame (akan diisi saat memilih) -->
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="button" id="clear-frame" class="inline-flex items-center px-3 py-2 rounded-md border border-gray-200 text-sm text-gray-500 hover:bg-gray-50 hidden">
                                Hapus
                            </button>
                        </div>
                    </div>
                ...
                <div class="p-6 border-b border-gray-100">
                    ...
                    <label for="photos" class="block">
                        <div id="drop-area" class="relative cursor-pointer rounded-lg border-2 border-dashed border-gray-200 bg-white p-8 flex flex-col items-center justify-center text-center transition hover:border-blue-300">
                            <input id="photos" name="photos[]" type="file" accept="image/*" multiple class="absolute inset-0 opacity-0 w-full h-full cursor-pointer" />
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div class="text-xs text-gray-400">Maksimal 10 foto, ukuran masing-masing maksimal 5MB</div>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            <label for="job_name" class="block mb-2 text-sm font-medium text-gray-600">Nama Pekerjaan</label>
                            <input id="job_name" name="job_name" type="text" placeholder="Misal: Liburan Keluarga 2024" class="w-full px-4 py-2 border rounded-lg text-gray-900 border-gray-200 focus:ring-2 focus:ring-blue-500" />
                        </div>
        ...
        <div class="max-w-2xl mx-auto text-center mt-8">
            ...
            <a href="{{ route('gallery.request') }}" class="inline-flex items-center gap-2 px-5 py-2 border rounded-md bg-white border-gray-200 shadow-sm text-gray-700 hover:bg-gray-50">
    ...
    (function () {
        ...
        function showPreview(files) {
            ...
            if (count) {
                ...
                fileCount.textContent = `${count}/${MAX_FILES}`;
            } else {
                resetPreview();
            }
        }
        ...
        function validateFiles(files) {
            ...
            if (files.length > MAX_FILES) {
                uploadHint.textContent = `Maksimal ${MAX_FILES} file.`;
                return false;
            }
            return true;
        }
        ...
        // Reset preview when the user clears files
